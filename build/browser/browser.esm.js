...
function b(e, t, n) {
	if (e.type === "file" && _(), e.type === "mem") return t(e);
...
var S = x;
async function C(e) {
	return e = typeof e == "string" ? await y(e) : v(e), b(e, t, u);
}
function w(e) {
	return typeof e == "string" && _(), b(e, n, d);
}
var T = w;
//#endregion
export { S as createNoOverride, x as createOverride, C as readExisting, w as readWriteExisting, T as readWriteExistingOrCreate };
